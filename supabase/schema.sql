...
create table if not exists public.profiles (
  ...
  is_student boolean default null,  -- null = not chosen yet, true = student, false = non-student
  university text,
  field_of_study text,
  year_of_study integer,
  -- Onboarding tracking
  has_completed_onboarding boolean default false,
  onboarding_step text default 'profile_choice',  -- 'profile_choice', 'student_info', 'username', 'complete'
...
-- Trigger pour créer automatiquement le profil
 ...
 begin
   ...
   values (
     new.id,
     new.email,  -- Utilise l'email comme username temporaire
     new.raw_user_meta_data->>'full_name'  -- Récupère le nom des metadata
   );
   return new;
 end;
...
-- =====================================================
-- 2. STORIES (Snapchat/Instagram style)
-- =====================================================
...
-- Index pour récupérer les stories actives rapidement
...
-- Fonction pour mettre à jour updated_at de conversation
...
-- Table pour suivre les relations (followers)
...
-- =====================================================
-- 6. MODULE ÉTUDIANT (Groupes, Ressources, Événements, Jobs)
-- =====================================================
...
-- Trigger pour créer les paramètres de notification par défaut
...
-- Profiles : visible par tous, modifiable par le propriétaire
...
-- Stories : visible par tous, modifiable par le propriétaire
...
-- Posts : visible par tous, modifiable par le propriétaire
...
-- Likes : modifiable par le propriétaire
...
-- Comments : visible par tous, modifiable par le propriétaire
...
-- Groups : visible par tous, rejoint par membres
...
-- Group members : visible par tous, modifiable par admins
 create policy "Group members are viewable by everyone"
   on public.group_members for select
   using (true);

-- Resources : visible par membres du groupe
...
-- Notification settings : modifiable par le propriétaire uniquement
...
-- Push tokens : modifiable par le propriétaire uniquement
...
-- =====================================================
-- 9. VUES ET REQUÊTES UTILES
-- =====================================================

-- Vue pour le feed avec info auteur
...
-- Vue pour les conversations avec dernier message
...
-- Vue pour les stats d'un profil
...
-- Insérer quelques universités pour le module étudiant
